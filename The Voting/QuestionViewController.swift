...
class QuestionViewController: UIViewController {
  ...
  //  }
    ...
    func winner() {
        if player1Tapped == player2Tapped && player2Tapped == player3Tapped && player2Tapped == player4Tapped && player2Tapped == player5Tapped && player3Tapped == 1
         {
