...
class EndScreenViewController: UIViewController {
    ...
    func overallWinner() {
        ...
        else if (info.player1won + info.player4won) * (3/2) > (info.player2won + info.player3won + info.player5won) / 3 {
            endScreenLabel.text = "\(info.player1) and \(info.player4) were thrown under the bus the most!"
        }
        else if (info.player1won + info.player5won) * (3/2) > (info.player2won + info.player4won + info.player3won) / 3 {
            endScreenLabel.text = "\(info.player1) and \(info.player5) were thrown under the bus the most!"
        }
        else if (info.player2won + info.player3won) * (3/2) > (info.player1won + info.player4won + info.player5won) / 3 {
            endScreenLabel.text = "\(info.player2) and \(info.player3) were thrown under the bus the most!"
        }
        else if (info.player2won + info.player4won) * (3/2) > (info.player1won + info.player3won + info.player5won) / 3 {
            endScreenLabel.text = "\(info.player2) and \(info.player4) were thrown under the bus the most!"
        }
        else if (info.player2won + info.player5won) * (3/2) > (info.player1won + info.player4won + info.player3won) / 3 {
            endScreenLabel.text = "\(info.player2) and \(info.player5) were thrown under the bus the most!"
        }
        else if (info.player3won + info.player4won) * (3/2) > (info.player1won + info.player2won + info.player5won) / 3 {
            endScreenLabel.text = "\(info.player4) and \(info.player3) were thrown under the bus the most!"
        }
        else if (info.player3won + info.player5won) * (3/2) > (info.player1won + info.player2won + info.player4won) / 3 {
